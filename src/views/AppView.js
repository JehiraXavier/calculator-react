  ...
  functionalButtonClick = (key) => {
    ...
    switch (key) {
      ...
      case "M+":
        ...
        let totalResult =
          parseFloat(resultText.length > 0 ? resultText : "0") + getMemoryValue;
      ...
      case "M-":
        ...
        let totalResult2 =
          parseFloat(resultText.length > 0 ? resultText : "0") - memValue2;
        ...
        <div className="row justify-content-center">
          <div className="col-md-5">
            <div className="app-header">
              <span className="app-title">Calculator with React</span>
            </div>
              ...
              <div className="row">
                ...
                <div className="col-md-12 calculator-body-part">
                  <div className="row justify-content-center">
                    <Button
                      isIcon={"fa fa-undo"}
                      buttonClass="btn btn-primary top-button"
                      onClick={this.undoClick}
                    />
                    <Button
                      buttonClass="btn btn-primary top-button"
                      isIcon={"fa fa-arrow-left"}
                      onClick={() => this.functionalButtonClick("CUT_FIRST")}
                    />
                    <Button
                      buttonClass="btn btn-primary top-button  text-bold"
                      onClick={() => this.functionalButtonClick("C")}
                      textValue="C"
                    />
                    <Button
                      buttonClass="btn btn-primary top-button  text-bold"
                      onClick={() => this.functionalButtonClick("AC")}
                      textValue="AC"
                    />
                  </div>
                  ...
                  <div className="row justify-content-center mt-2">
                    <Button
                      buttonClass="btn btn-success btn-mem text-bold"
                      onClick={() => this.functionalButtonClick("MC")}
                      textValue="mc"
                    />
                    <Button
                      buttonClass="btn btn-success btn-mem text-bold"
                      onClick={() => this.functionalButtonClick("M+")}
                      textValue="m+"
                    />
                    <Button
                      buttonClass="btn btn-success btn-mem text-bold"
                    ...
                    <Button
                      buttonClass="btn btn-success btn-mem text-bold"
                      onClick={() => this.functionalButtonClick("MR")}
                      textValue="mr"
                    />
                  </div>
                  ...
                  <div className="row justify-content-center mt-2">
                    <Button
                      buttonClass="btn btn-primary btn-digit-operation btn-digit text-bold"
                      onClick={() => this.digitClick(7)}
                      textValue="7"
                    />
                    <Button
                      buttonClass="btn btn-primary btn-digit-operation btn-digit text-bold"
                      onClick={() => this.digitClick(8)}
                      textValue="8"
                    />
                    <Button
                      buttonClass="btn btn-primary btn-digit-operation btn-digit text-bold"
                      onClick={() => this.digitClick(9)}
                      textValue="9"
                    />
                    <Button
                      buttonClass="btn btn-primary btn-digit-operation btn-operation text-bold"
                    ...
                    <Button
                      buttonClass="btn btn-primary btn-digit-operation btn-operation text-bold"
                      textValue="√"
                      onClick={() => this.functionalButtonClick("SQ_ROOT")}
                    />
                  </div>
                  ...
                  <div className="row justify-content-center mt-2">
                    <Button
                      buttonClass="btn btn-primary btn-digit-operation btn-digit text-bold"
                      onClick={() => this.digitClick(4)}
                      textValue="4"
                    />
                    <Button
                      buttonClass="btn btn-primary btn-digit-operation btn-digit text-bold"
                      onClick={() => this.digitClick(5)}
                      textValue="5"
                    />
                    <Button
                      buttonClass="btn btn-primary btn-digit-operation btn-digit text-bold"
                      onClick={() => this.digitClick(6)}
                      textValue="6"
                    />
                    <Button
                      buttonClass="btn btn-primary btn-digit-operation btn-operation text-bold"
                    ...
                    <Button
                      buttonClass="btn btn-primary btn-digit-operation btn-operation text-bold"
                      onClick={() => this.functionalButtonClick("x^2")}
                      textValue="x^2"
                    />
                  </div>
                  ...
                  <div className="row justify-content-center mt-2">
                    <Button
                      buttonClass="btn btn-primary btn-digit-operation btn-digit text-bold"
                      onClick={() => this.digitClick(1)}
                      textValue="1"
                    />
                    <Button
                      buttonClass="btn btn-primary btn-digit-operation btn-digit text-bold"
                      onClick={() => this.digitClick(2)}
                      textValue="2"
                    />
                    <Button
                      buttonClass="btn btn-primary btn-digit-operation btn-digit text-bold"
                      onClick={() => this.digitClick(3)}
                      textValue="3"
                    />
                    <Button
                      buttonClass="btn btn-primary btn-digit-operation btn-operation text-bold"
                    ...
                    <Button
                      buttonClass="btn btn-primary btn-digit-operation btn-operation text-bold"
                      onClick={() => this.functionalButtonClick("1/x")}
                      textValue="1/x"
                    />
                  </div>
                  ...
                  <div className="row justify-content-center mt-2">
                    ...
                    <Button
                      buttonClass="btn btn-primary btn-digit-operation btn-operation text-bold"
                      onClick={() => this.functionalButtonClick("+-")}
                      textValue="±"
                    />
                    <Button
                      buttonClass="btn btn-primary btn-digit-operation btn-operation text-bold"
                    ...
                    />
                    <Button
                      buttonClass="btn btn-primary btn-digit-operation btn-equal text-bold"
